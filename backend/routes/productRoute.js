...
const { addProduct, getProducts, getUserProducts, getSingleProduct, createBid, getBid, addComment, getComment, deleteProduct, updateProduct, RejectBid } = require("../controllers/productController");
