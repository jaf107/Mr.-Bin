...
export const ACCEPT_REJECT_BID_FAIL ="ACCEPT_REJECT_BID_FAIL";
export const ACCEPT_REJECT_BID_SUCCESS = "ACCEPT_REJECT_BID_SUCCESS";
export const ACCEPT_REJECT_BID_REQUEST = "ACCEPT_REJECT_BID_REQUEST";
